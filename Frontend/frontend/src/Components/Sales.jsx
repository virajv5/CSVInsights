...
function Sales() {
  ...
  const handleFileUpload = async (e) => {
    ...
    console.log('Uploading file:', csvFile);  // Add this for debugging
  ...
  const handleGetAnswer = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/project/generate-sales-query/', { text: question });
  ...
  return (
    <>
      ...
      <Form style={{ width: "800px", marginTop: "10px", marginLeft: "450px" }}>
        ...
        <FormGroup>
          <Label for="csv_file">Upload Your Sales CSV</Label>
          <Input 
            id="csv_file" 
            name="csv_file" 
            type="file" 
